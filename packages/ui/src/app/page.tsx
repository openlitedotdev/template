...
export default function Home() {
  return (
    <>
      <section className=" bg-dark-900 bg-cover md:bg-container w-full bg-no-repeat  lg:bg-center lg:bg-cover">
        <div className="mx-auto container relative">
          <Header />
          <section className="text-white p-4 md:px-24  flex justify-center h-[100vh] items-center">
            <div className="w-full md:w-5/5 lg:w-4/5 flex flex-col  gap-6 lg:gap-10">
              <article className="bg-opacity-50 rounded-lg shadow-2xl p-8 flex flex-col gap-8  transition-all duration-1000 ease-in-out">
                ...
                <p className="text-white text-lg leading-snug text-pretty text-center">
