export default function AboutPage() {
  ...
  const modules = [
    {
      title: 'Rest API',
      description: 'Built in Python and its popular FastAPI framework',
    },
    {
      title: 'Dashboard',
      description: 'Built in react and the Open UI library',
    },
    {
      title: 'Ui',
      description:
        'Built on next with a modern, customizable interface and scalable architecture',
    },
  ]
  return (
    <div className="mx-auto max-w-7xl p-8 pb-16">
      ...
      <div className="prose">
        <div>
          <p>
            Starter pack for building performant e-commerce experiences
            with&nbsp;
        ...
        <ul>
          {stack.map((tech, i) => (
            <li key={i} className="py-2">
              <b className="text-primary font-semibold py-2">{tech.title}</b>
        ...
        <ul>
          {modules.map((module, i) => (
            <li key={i} className="py-2">
              <b className="text-primary font-semibold py-2">{module.title}</b>
